        ...
        >
          <div className="comic-popup-front absolute w-full h-full bg-frost backdrop-blur rounded-lg p-3">
            <div className="comic-info-container w-full h-full flex flex-col bg-plum-500 p-4 rounded-lg">
              ...
              <div className="comic-description-container w-full mb-8 md:mb-2 h-[15%] md:h-3/10">
          ...
          <div className="comic-popup-back absolute flex flex-row justify-end w-full h-full bg-frost backdrop-blur rounded-lg p-3">
            ...
            <div className="controller-container absolute flex flex-row w-2/5 h-fit gap-2 justify-end m-4">
              ...
              <form method="dialog">
                <button
                    className="btn bg-plum-300 btn-sm btn-circle btn-ghost text-lg leading-8 h-fit  m-0 flex items-center justify-center outline-none text-center md:absolute right-1">
                  ✕
                </button>
              </form>
            </div>
