    ...
    <>
      <div className="h-screen w-full bg-plum overflow-y-hidden">
        ...
        {window.location.pathname.includes("chapter") ? (
          ...
          <div className="content-container px-6 h-4/5 overflow-y-scroll scroll-m-0 scroll-p-0 md:h-90/100 lg:h-90/100 xl:h-90/100 2xl:h-90/100">
            <Outlet />
          </div>
        )}
        ...
        {window.location.pathname.includes("chapter") ? (
          ...
          <div className="footer-container w-full h-1/10 block md:hidden lg:hidden xl:hidden 2xl:hidden">
